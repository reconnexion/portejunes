...
// to a user's outbox) to make signed cross-domain requests -- without it, listener registration
// fails with "Service 'signature.proxy.query' is not found" and pay-activity.service.js's
// onEmit/onReceive never fire. Confirmed by inspecting the failed Bull job's stacktrace during
// the e2e test.
